...
* For predictive SLS, a convex optimization problem we have implemented is as follows: PSLS = min_{Phi_x, Phi_u, Phi_hat_x, Phi_hat_u} || [[Q^{1/2}, 0]; [0, R^{1/2}]] [[Phi_x, Phi_hat_x]; [Phi_u, Phi_hat_u]] ||^2_Frob
